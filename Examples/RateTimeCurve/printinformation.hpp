...
/*! \file rate_time_curve_hpp
    \brief Example with rate time curves
*/

#ifndef rate_time_curve_print_information_hpp
#define rate_time_curve_print_information_hpp
...
#endif // rate_time_curve_print_information_hpp
