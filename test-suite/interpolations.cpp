...
#include <ql/math/interpolations/polynomialinterpolation.hpp>
...
void InterpolationTest::testPolynomialInterpolation() {
    BOOST_TEST_MESSAGE("Testing polynomial interpolation...");

    Array x({0.1, 0.25, 0.5, 0.75, 0.9});
