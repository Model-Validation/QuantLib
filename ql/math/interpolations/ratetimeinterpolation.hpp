    ...
    class RateTimeLinear {
      public:
        ...
        Interpolation interpolate(const I1& xBegin, const I1& xEnd, const I2& yBegin) const {
            return RateTimeLinearInterpolation(xBegin, xEnd, yBegin);
        }
    ...
    */
    ...
    class RateTimeCubic {
      public:
        ...
        template <class I1, class I2>
        Interpolation interpolate(const I1& xBegin, const I1& xEnd, const I2& yBegin) const {
            return RateTimeCubicInterpolation(xBegin, xEnd, yBegin, da_, monotonic_, leftType_,
    ...
    class RateTimeMixedLinearCubic {
      public:
        ...
        template <class I1, class I2>
        Interpolation interpolate(const I1& xBegin, const I1& xEnd, const I2& yBegin) const {
            return RateTimeMixedLinearCubicInterpolation(xBegin, xEnd, yBegin, n_, behavior_, da_,
