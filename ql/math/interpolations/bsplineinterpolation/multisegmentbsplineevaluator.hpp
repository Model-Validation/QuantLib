...
/*! \file multisegmentbsplineevaluator.hpp
    \brief B-spline basis function evaluator for multi-segment curves
*/

#ifndef quantlib_multisegment_bspline_evaluator_hpp
#define quantlib_multisegment_bspline_evaluator_hpp
...
namespace QuantLib {
    ...
    // We need to duplicate the enum here to avoid circular dependency
    // This must match BSplineSegment::Side exactly
    enum BSplineSide { 
     ...
     */
    class MultiSegmentBSplineEvaluator {
    public:
        /*!
         ...
         */
        MultiSegmentBSplineEvaluator(const std::vector<ext::shared_ptr<BSplineSegment>>& segments,
                         Size numVariables);
        ...
        Eigen::VectorXd evaluateAll(Real x, 
                                    BSplineSide side = SideRight) const;
    ...
    private:
         ...
         */
        Size findSegmentIndex(Real x, BSplineSide side) const;
    };

}

#endif // quantlib_multisegment_bspline_evaluator_hpp