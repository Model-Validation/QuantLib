...
namespace QuantLib {
    ...
    class BSplineSegment {
      public:
        ...
        /*!
         * \brief Construct and return a matrix representing the anti-derivative operation.
         * \param degree The degree of the spline.
         * \param t0 The value at the left end point or any given point of the anti-derivative
         * spline.
         * \param differenceOperator Boolean indicating if the difference operator should be
         * used.
         * \return A matrix representing the anti-derivative operation.
         */
