...
/*! \file rtstructure.hpp
    \brief RT-based yield term structure
*/

#ifndef quantlib_rt_structure_hpp
#    define quantlib_rt_structure_hpp
...
namespace QuantLib {
    ...
    */
    class RateTimeStructure : public YieldTermStructure {
      public:
        /*! \name Constructors
        ...
        */
        //@{
        explicit RateTimeStructure(const DayCounter& dayCounter = DayCounter());
        explicit RateTimeStructure(const Date& referenceDate,
                                      const Calendar& cal = Calendar(),
                                      const DayCounter& dayCounter = DayCounter(),
                                      const std::vector<Handle<Quote>>& jumps = {},
                                      const std::vector<Date>& jumpDates = {});
        RateTimeStructure(Natural settlementDays,
                             const Calendar& cal,
                             const DayCounter& dayCounter = DayCounter(),
                             const std::vector<Handle<Quote>>& jumps = {},
                             const std::vector<Date>& jumpDates = {});
    ...
    inline DiscountFactor RateTimeStructure::discountImpl(Time t) const {
